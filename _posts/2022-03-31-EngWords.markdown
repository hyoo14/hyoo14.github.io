...
*day14-lethal modest deflect highlight exert recurring meager prevail exclusively consensus now-and-then discrete improbable  
    undisputed allocation inconclusive withstand cornerstone mobilize given-that cargo solitary coinage reconcile obligation  
    sever foremost surge hasten tentatively scorn throughout pitfall befall coupled-with span hollow hallow appreciable  
    spearhead ethodically  
    -pernicious small not-large limited simple unpretentious constituent misuse completely strongly divert stress underline accent  
    apply exercise employ put-forth wield prospective latent recurrent scanty scarce very-low deficient be-dominant dominate  
    bewidespread be-prevalent triumph soley only entirely totally occasionally from-time-to-time at-times secure fasten unlikely  
    implausible doubtful recognized allotment assignment not-definitive indecisive underpining indication trace inadvertently pinnacle  
    height incessant exhaustive intesive put-into-action deploy accepting-that shipment load freight secluded somewhat inconceivable 
    creation innovation bring-together reunite rigorous strict liability preeminent wax accelerate rush speed-up hesitantly ridicule  
    disdain sneer despise during-every-part-of during-the-whole-of mammoth extend-across cover cross unfilled sanctify revere  
    significant noticeable considerable  head systematically   
*day13-merely decimate inceptive retrieve compress designate dissemination hypothetical flowing stipulate evident full-fledged  
    laborious tantalizing transmit candidly compulsorily deliberation preposterous occasionally inconceivable breeding overriding  
    override favor sediment predominate realize circuitous owing-to model with-respect-to damaging heighten seep  
    -inducement recover obtain regain condense compact contract crush identify define spread distribution diffusion discernible  
    imaginary require demand call-for orientation enrich intensify manifest full-blown strenuous industrious dilligent give-off release  
    discharge send-out breathtaking tempting enticing teasing convey communicate send plainly by-requirement obligatorily  
    mandatorily reflection unbelievable absurd nonsensical scattered thinly-distributed scanty meager scarce once-in-a-while  
    now-and-then propagation dominant chief principal take-precedence-over len-toward deposition regularly typically assess  
    proportion outweigh prevail most-popular be-aware-of understand catch-on achieve accomplish fulfill roundabout as-a-result-of  
    specimen prototype example in-terms-of in-reference-to uninterrupted ongoing unceasing consecutive innominate detrimental  
    noxious increase intensify allotment curtly abruptly apart-from ooze custom   
