...
*day21-dissipate profound intriguing ingenuity conquer spell facet  
    mundane mere intrusive intrude culminate-in prompt distinction   
    appreciation flag ambivalent term destitute-of principal juncture discount   
    or-so dejected for-all erode errosion sporadic thrill mutilate rigidly   
    matter contradicting unwilling   
    -do-well disperse scatter squnder waste great significant fundamental   
    far-reaching interesting-but-not-completely-understood fascinating   
    appreciably fairly creativeness inventiveness cleverness defeat prevail   
    triumph acquisition break-apart shatter divide a-certain-period-of-time   
    aspect phase ordinary banal commonplace crowded thick compact    
    unplanned unpredictable chance nothing-more-than insignificant   
    interfering meddlesome push-in encroach reach-completion-in   
    reach-the-highest-point-in hold-in-place support cause bring-about   
    induce stimulate difference divergence contrast steady stationary   
    uncahgeable understanding comprehansion expertise urbanity refinement   
    proclamation  lesson weaken fade wither mark label mixed unsure    
    undecided call name designate denominate lacking empty-of deficient-in   
    lamentably sadly basic-method original-method comprise connection   
    junction link ignore disregard roughly depressed downhearted in-spite-of   
    with-all despite distinctively censure wear-down wear-away wear-out   
    corrosion strain pressure antique occasional intermittent irregular   
    infrequent crest acme exhaustive scrupulous conclude derive reason   
    deduce central-idea center heart change variation alteration excitement   
    exhilaration frisson damage injure disable rigorously severly substance   
    material stuff issue be-important opposing reluctant   
