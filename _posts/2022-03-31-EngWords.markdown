...
*day25-consequent decimation evoke elaborate enigmatic pragmatic dogmatic   
    ...
    immutable imputable yardstick conviction hallmark   
    ...
    strong-opinion faith feature distinguishing-trait sure-signal   
...
*day23-configuration induce retain detain erratic eventual mandate requisite  
    requite partake-of pledge dictate durable collectively furnish determine  
    determined haul found-wanting classic grossly vivid transplant implement    
    excavate secluded engulf truism perpetuate illusory heyday proficient amply  
    desolate more-subtle disrupt forerunner immediate wield crush manner uneasy  
    -arrangement shape form conformation persuade convince irregular  
    unpredictable uneven ultimate final order command instruction necessity  
    requirement essential required necessary return repay consume share promise  
    oath vow undertaking maintain boundary cramp enclose cage require suggest  
    prescribe determine long-lasting lasting enduring together all-together unitedly  
    provide supply offer metamorphose resolve conclude figure-out calculate  
    resolute firm draw pull drag heave nearness closeness proximity  
    judged-inadequate typical exemplary model best finest excessively bright  
    brilliant graphic lifelike synthetic place-in-another-context remove relocate hide  
    disguise conceal tool instrument appliance execute enforce dig-out dig-up  
    unearth disinter distaste nausea aversion remote hidden isolated solitary  
    swallow self-evident-truth commonplace cliche inadvertent devise originate  
    characteristic-of make-visible exhibit uncover subject continue immortalize  
    eternize misleading deceptive delusive high-point golden-age prime  
    florescence skilled skillful expert adept generously bountifully lavishly deserted  
    bleak dreary lonely solitary less-noticeable interfere-with interrupt upset  
    predecessor antecedent prompt on-the-spot nearest neighboring adjacent  
    exercise use handle discourage deflate squash crumble way fashion mode  
    apprehensive unstable disturbed ill-at-ease  
