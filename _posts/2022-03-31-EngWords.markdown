...
*day18-initiative provided-that phenomenal likewise tangible absurd  
    inclement overly consume overall proliferation copious negligible  
    notably worshiper pool at-the-urging-of regime acclaim reclaim  
    declaim disparity bold allied authoritative moral compatible stress  
    peculiarity rely-upon saturate constitution efface routinely  
    implication unambiguous rigor contentious string decompose lateral   
    -enterprise ambition drive plan scheme if once on-the-condition-that  
    supposing extraordinary remarkable similarly in-the-same-way also as-well  
    material physical concrete substantial ridiculous preposterous ludicrous  
    unfavorable harsh severe excessively inordinately unduly destroy devastate  
    demolish eat devour general total comprehensive advance further forward  
    multiplication insignificant slight minor trivial particularly especially 
    in-particular combination put-together combination group  
    at-the-recommendation-of embellishing administration applaud apprehensible   
    inequality disproportion daring brave courageous vivid bright important  
    significant drawn-out-of linked connected official authorized lesson message  
    teaching consistent congruous consonant emphasize highlight underline  
    emphasis accent particular feature characteristic quality depend-upon  
    resort-to swift soak drench wet-thoroughly charter form structure wipe-out  
    erase expunge affordable easy-to-handle move-toward come-forward near  
    reach method way commonly regularly habitually adjust acclimate conform  
    consequence result inference intimation clear distinct definite harshness  
    strictness rigidness hardship adversity capable sufficient adequate  
    inconceivable series chain side   
*day17-ultimate brittle impetus impetuous orchestrate hamper roughly orientation orient  
    converge inflate terrain in-earnest agile standstill persuasively miraculous intangible secure  
    subsist archive mode commemorate henceforth transparent prominence incorporate  
    meticulous dismantle lavish dormant exempt rather judiciously tolerate  
    -lengthy extended protracted comparable supreme fundamental basic primary leader  
    founder introduce tradition spur impulse hasty rash limit margin coordinate organize  
