...
*day15-intact albeit attainment progressively setback cutback supress incidentally tacit sustained radical grasp precipitate interlock accordingly  
    remarkably disputable congeal realm dimension deplete ice-sheet bountifully periphery apparently far-reaching embody evade against  
    oblige identical intimately spot immerse be-tempted-to inception   
  -whole complete unaffected intricate elaborate involved system standard usual sensible sufficient fulfillment increasingly hold-back restrain  
    stop-by-force by-the-way maneuver implicit implied establish-the-truth-of constant continued uninterrupted prolonged fundamental basic  
    extreme drastic high-quality superior main comprehend apprehend grip seize conspicuously notably bring-about cause give-rise-to trigger  
    link connect join consequently for-the-reason applicable pertinent germane surprisingly challengeable debatable arguable solidify harden  
    stiffen condense cover wary prudent discreet sphere domain praise magnify magnitude exhaust empty use-up reduce distinctive peculiar  
    special quality onlooker copiously plentifully exuberantly lose-the-ability-to-move fluctuation difference edge boundary border fringe  
    seemingly ostensibly outwardly evidently extensive widespread board incarnate represent manifest contain incorporate elude shun next-to  
    beside  awing-to attrubutable-to arrange assort force require compel assist benefit indistinguishable equal dubious detect see find cover  
    plunge dip be-inclined-to beginning  
...
*46. due to  
*46. caused by, awing to, attributable to  
