...
* research and class   
** adML  
*** augmentation and densenet  
** asML  
*** report and new test including all shapes(전체형상?몸전체?)  
* etc  
o  
...
* research and class  
** adML
*** upgrade and make format  
** asMl  
*** write and metric test  
o  
...
cd ncbi-blast-2.12.0+/
  ...
  937  cd bin/
  938  ll
  939  cd astral_combined
sbatch run_blastp_m8_extend_time_noLimit.sh astral-scopedom-seqres-gd-all-2.08-2023-01-06_subse                                                  t_2345678910.fa new_blastp_astral_scope_result2345678910.m8
 ...
 cd MMseqs2/
  ...
  914  ls
  915  ll
  916  cd astral_combined
sbatch run_mmseqs2_m8_noLimit.sh astral-scopedom-seqres-gd-all-2.08-2023-01-06_subset_234567891                                                  0.fa new_mmseqs2_astral_scope_result2345678910.m8



sbatch run_diamond_m8_noLimit.sh db_diamond_astral_scope_2345678910 new_diamond_astral_scope_re                                                  sult2345678910.m8
...
* etc  
o  
adML 은 이제 augmentation해봐야할듯 그리고 densenet?  더 최신 큰 모델도 시도해봐야  
