...
* active  
** plan biosyn(AC)   
** db for chem(IC or BI)   
** bias additionally audio(AC)    
...
** aud_bias    
*** audio-flamingo?    
*** 2 closed model simple examples    
** bio_plan_bench..?  
*** agent for correction? use llm for check up and correct?  
...
** run qvlm qimage  
** abs sub? add ks or not?  
** multiple cases for ssl and measuring uncertainty  
** code for vs cluster?  
