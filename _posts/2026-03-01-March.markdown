...
** APIs with tests(plan)      
** APIs with tests(movie mem)       
** med(new format)  
** gssl(writing?) and dna robustness(new format to where?)      
...
* active      
** 1. fair vllm bench+Label bias(COL, doc contact and new format-ing)     
** 2. plan biosyn test(arr_m or col)       
** 3. additionally for MOVIE?(arr_m or col)        
** 4. ssl for dna(NAR_g) and gene robust(NAR_g)    
...
* active  
** 1. diffusion+text for bio(TM, additional human eval-ing)    
** 2. fair vllm bench+Label bias(COL, doc contact and new format-ing)     
** 3. plan biosyn test(arr_m or col)       
** 4. additionally for MOVIE?(arr_m or col)        
...
** bidirectional(write and extra)     
** APIs with tests(plan)      
** dataset(movie mem)       

** med(contact and new format)  
...
** 1. int prep     
** 2. fair vllm bench+Label bias(COL, doc contact and new format-ing)     
** 3. diffusion+text for bio(TM, additional human eval-ing)    

** 4. plan biosyn test(arr_m or col)       
** 5. additionally for MOVIE?(arr_m or col)        
...
Monday, March 02, 2025   
* research  
o   


Tuesday, March 03, 2025   
* research  
o   
...
* active  
** 1. int prep     
** 2. fair vllm bench+Label bias(?doc contact and new format)     
** 3. diffusion+text for bio(TM, additional human eval)    
