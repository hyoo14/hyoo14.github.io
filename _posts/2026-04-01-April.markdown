...
* active      
** 1. ssl for dna(NAR_g) git code test and expand with microbiome data    
** 2. fair vllm bench+Label bias(EMN, doc contact and new format-ing)     
** 3. gene robust(NAR_g)   
...
* priority (todo)      
** gssl(code test and expand)->reform repo for making available for new data     
** prop exam prepare(also link to srw-ish session?)    
** med(new format) ALSO with bn and other workshops             




** review paper    
** dna robustness(new format)       
...
* priority (todo)      
** gssl(code test and expand)->little add and upload         
** dna robustness(new format)->contact, update, upload        
** prop exam prepare(also link to neurips session)->update ssl and big story       
*** neu(5/4)         
** med(new format)                    
*** sterea workshop(5/11)      
...
* active      
** 1. bidir_aug(rebut tm)     
** 2. fair vllm bench+Label bias(EMN, doc contact and new format-ing)     
** 3. gene robust(NAR_g)   
** 4. gssl review paper(mdb)   
** 5. ssl for dna(NAR_g) git code test and expand with microbiome data    
...
* active      
** 1. fair vllm bench+Label bias(COL, doc contact and new format-ing)     
** 2. plan biosyn test(col)       
** 3. additionally for MOVIE?(col)        
** 4. ssl for dna(NAR_g) and gene robust(NAR_g)    
...
** bidir_aug(rebut tm)     
** med(new format)  
** dna robustness(new format to where?)      
** gssl(code test and expand?)    
