...
* active   
** 0. presentations and records(pa1, ac2, bn1)    
** 1. plan biosyn test rebut(col)       
** 2. additionally for MOVIE rebut(col)    
** 3. prop exam after paper    
** 4. fair vllm bench+Label bias(EMN)     
...
** 1. gssl(ngb)             
** 2. dna robustness(tcb)  
** 3. prop originated 3 biomm eval(neu)  
** 4. streacult_clinic(streocult)   
** 5. med bias(emp)  
** 6. arouasal, crm(emp)  
...
* priority (todo)      
** upload presentation pak diap(6/01)   
** rebut for col    
                : v mem  
                : bio plan  
** github (more models update, inner due 6/02)    
** upload presentation ac 3? bn 1?(6/04)  

*later  

** prop exam after paper..  
...
** pak diap script and present(6/11)   
** prepare demo(June)  
** little update ssl review paper(June)    
** revision tcb robust  
...
* active      
** 1. fair vllm bench+Label bias(EMN, doc contact and new format-ing)     
** 2. gssl review paper(mdb) wait for review by advisor     


* wait  
** 1. plan biosyn test(col)       
** 2. additionally for MOVIE?(col)        
** 3. gssl(ngb)             
** 4. dna robustness(tcb)  
** 5. prop originated 3 biomm eval(neu)  
** 6. streacult_clinic(streocult)   
...
* priority (todo)      
** emn(5/25): med(dataset collect finish and test and write) (inner 5/19)   
            : survey for arousal trajectory (inner 5/19)        
** prop exam update and share to profs, share and talk to profs as many as possible    
** prepare demo(5/20)  
** little update ssl review paper(5/20)             

** github (more models update, inner due 5/20)    
...
** 1. fair vllm bench+Label bias(EMN, doc contact and new format-ing)     
** 2. gssl review paper(mdb) wait for review by advisor     
** 3. bidir_aug(cam tm 5/23)     
** 4. clinic_bias(cam bion 5/18)  
...
* priority (todo)      
** github (more models update)    
** med(new format!): emn(5/25)  (contact ks and doc)   
** prop exam prepare->update ssl for her data? ask profs to review before exam (share)           

** camera(2, due 5/18 and due 5/23)    
** volunteer(2, including dandifund, due 5/14)      
...
* priority (todo)      
** med(new format!): emn(5/25)  (contact ks and doc)    
** survey for arousal trak (format and 5)    
** prop exam prepare->update ssl for her data? ask profs to review before exam (share)           
...
** 1. plan biosyn test(col)       
** 2. additionally for MOVIE?(col)        
** 3. bidir_aug(rebut tm)     
** 4. gssl(ngb)             
** 5. dna robustness(tcb)  
** 6. prop originated 3 biomm eval(neu)
...
** sterea workshop(5/11)      
** med(new format!): emn(5/25)   
** prop exam prepare->update ssl for her data? ask profs to review before exam         
...
* active      
** 1. ssl for dna(NAR_g) add another optional input part and submit    
** 2. fair vllm bench+Label bias(EMN, doc contact and new format-ing)     
** 3. gene robust(NAR_g) reinforcement and submit    
** 4. gssl review paper(mdb) wait for review by advisor     
...
** review paper(5/1, ing)      
*** neu(5/4)         
** med(new format)                    
** SSL present prepare(5/4)  
          
** prop exam prepare(also link to neurips session)->update ssl and big story       
*** sterea workshop(5/11)      
*** neu(5/4) or emn(5/25)     
