...
* prepare present  
** 1. clinic_bias(biowork 7/2)  
** 2. clinic_cultural_bias(stereawork 7/2)  
...
* active   
** 0. poster(streocult)    
** 1. prepare CFP present  
** 2. prop exam after paper    
** 3. dna robustness(tcb)  
** 4. gssl review paper(mdb)   
     


* wait          
** 1. gssl(ngb)           
** 2. prop originated 3 biomm eval(neu)  
** 3. plan biosyn test rebut(col)       
** 4. additionally for MOVIE rebut(col)    
** 5. med bias(emp)  
** 6. arouasal, crm(emp)  
...
** submit and register strea  
** CFP presentation(ari abandoned dre..)    
** github (more models update, inner due 6/17)    
** prop exam after paper.. 
...
* wait
** for acl, scholarship inquire mail  
** submit pakdd update    
** rebut for col    
                : v mem  
                : bio plan  
...
** github (more models update, inner due 6/13)    
...
* priority (todo)      
** github (more models update, inner due 6/02)    
** upload presentation ac 1 or 2? bn 1?(6/04)  
** prop exam after paper.. 
...
* priority (todo)      
** github (more models update, inner due 6/09)    
