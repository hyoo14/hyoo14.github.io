...
** 1. additionally for MOVIE new venue(w)       
** 2. dna robustness revision(tcb, due 8/28)     
** 3. derma med bias new venue(w or a)    
** 4. int                   
** 5. plan biosyn test new venue(na?)           
** 6. new propose for HK group and others(2)        
** 7. new dynasift(na?)   
** 8. gssl review paper(mdb)     
...
** 1. plan biosyn test new venue(tm?)         
